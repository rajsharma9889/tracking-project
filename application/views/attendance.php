                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="<?= base_url('admin/track_location?sales_person=' . $row->user_id . '&start_date=' . $row->in_date . '&end_date=' . $row->in_date . '&filter='); ?>"><i class="square fa-solid fa-location click" data-toggl="tooltip" data-placement="top" title="Location Path"></i></a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
