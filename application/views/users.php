        ...
        <div class="container-fluid">
            <div class="row justify-content-start sp">
                ...
                <div class="col-8 d-flex justify-content-end">
                    <a class="btn denbtn" href="<?= base_url('admin/add_users'); ?>">Add Sub Admin</a>
                </div>
            </div>
        </div>
        <div class="scroll">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/update_users/' . $row->id); ?>"><i class="square fa-solid fa-pen-to-square click" data-toggl="tooltip" data-placement="top" title="Update" data-target="#jobs-update"></i></a>
                                <a href="<?= base_url('admin/sale_person_view/' . $row->id); ?>"><i class="square fa-solid fa-user bg-warning click" data-toggl="tooltip" data-placement="top" title="Sale Person" data-target="#jobs-updat"></i></a>
