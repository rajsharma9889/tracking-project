                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/update_sale_person/' . $row->id); ?>"><i class="square fa-solid fa-pen-to-square click" data-toggl="tooltip" data-placement="top" title="Update" data-target="#jobs-update"></i></a>
