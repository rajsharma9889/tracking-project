        ...
        <div class="container-fluid">
            <div class="row justify-content-start sp">
                ...
                <div class="col-8 d-flex justify-content-end">
                    <button class="btn denbtn" onclick="ajax_modal('modal/ajax_modal/modal_create_designation', '', this)">Add designation</button>
                </div>
            </div>
        </div>
        <div class="scroll">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="vajascript:void(0)"  onclick="ajax_modal('modal/ajax_modal/modal_update_designation', '<?= $row->id ?>', this, '<?= $row->designation?>')" title='Update'><i class="square fa-solid fa-pen-to-square" ></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
