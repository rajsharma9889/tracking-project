                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/track_location?sales_person=' . $row->id . '&start_date=' . date('Y-m-d') . '&end_date=' . date('Y-m-d') . '&filter=&id'); ?>"><i class="square fa-solid fa-location click" data-toggl="tooltip" data-placement="top" title="Today Path"></i></a>
